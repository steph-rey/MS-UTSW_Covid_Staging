...
all_pt_days <- all_pt_days %>% 
    ...
    mutate(stage = factor(stage,
        ...
        filter(LOS>1)         # Exclude patients where LOS<=1 -- only include inpatients 
```
...
# Looking at summary table, there is a very extreme outlier (one patient that has a LOS of 30,000 days)... we need to remove this outlier from the dataset
all_pts_days <- all_pt_days[-which(all_pt_days$ID=="Z7784695"), ]
```
